...
/*
1. register
    a. send username, docs
    b. get link
    c. use link to add address to whitelist

2. login
    a. username to verify
    b. cast vote



sign identifier with wallet
-> store in whitelist

when voting
-> check sign + check owner





signedusername, wallet

onvote -> check if wallet in whitelist
          check if unsigned username = entered username
